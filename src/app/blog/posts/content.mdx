...
Replace the `public/images/lucas-hale-picture.jpeg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
